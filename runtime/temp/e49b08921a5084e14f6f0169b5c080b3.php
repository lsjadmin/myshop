<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:89:"D:\phpstudy2018\PHPTutorial\WWW\myshopa\public/../application/index\view\login\login.html";i:1550577662;}*/ ?>
<!DOCTYPE html>
<html>
							...
							<div class="login-form">
								<form>
									<div class="user-name">
										...
										<!-- <?php echo \think\Cookie::get('name')['account']; ?> -->
										<input type="text" id="account" value="<?php echo \think\Cookie::get('name')['account']; ?>" placeholder="手机号/邮箱">
									</div>
									<div class="user-pass">
										<label for="user_pwd"><i class="am-icon-lock"></i></label>
										<input type="password" id="user_pwd" value="<?php echo cookie('name')['user_pwd']?>" placeholder="请输入密码">
									</div>
								</form>
							</div>
